...
class LocalPropertyManager(LanguageManager, LocalAttributesBase):
    ...
    security.declarePrivate('_setLocalPropValue')
    ...
    security.declarePrivate('_setLocalProperty')
    def _setLocalProperty(self, id, type, lang=None, value=None):
        ...
        if lang is not None:
            self._setLocalPropValue(id, lang, value)


    security.declarePrivate('_delLocalProperty')
    ...
    def manage_editLocalProperty(self, id, REQUEST, RESPONSE=None):
        ...
        for lang in self.get_languages():
            if REQUEST.has_key(lang):
                self._setLocalPropValue(id, lang, REQUEST[lang].strip())
    ...
    security.declarePublic('getLocalProperty')
